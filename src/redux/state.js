...
let state = {
    ...
    messagesPage: {
        dialogs: [
            ...
            {id: '2', avatar: 'https://www.meme-arsenal.com/memes/c7b480944fe90f7e7c5e1ba5c8200cd2.jpg', name: 'Nata'},
            {id: '3', avatar: 'https://apkshki.com/storage/5005/icon_5f2c4f42ad9c2_5005_w256.png', name: 'Vasylyna'},
            {
                id: '4',
...
export const updateNewMessageValue = (newText) => {
    ...
    state.messagesPage.newMessageValue = newText;
    rerenderEntireTree(state);
}
...
export const sendMessage = () => {
    ...
    let newMessage = {
        idOut: 3,
        textOut: state.messagesPage.newMessageValue
    };
    state.messagesPage.messagesOut.push(newMessage);
